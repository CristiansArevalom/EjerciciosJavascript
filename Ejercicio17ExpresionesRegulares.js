...
5. Por medio de expresiones regulares determine si una cadena de texto dada es un correo 
teniendo en cuenta las siguientes condiciones:
a. Debe tener @
b. Debe tener .co
 * 
 */
let palabras =["edificio", "perla", "estrella", "pescado", 
"salero", "biblioteca", "guitarra", "dinero", "música"]
...
let palabra="correoposible@gmail.com"
let expReg =  new RegExp("^((\w+|\-|\.))+@[a-zA-Z]+\.com$");
console.log(expReg.test(palabra))
