...
Técnica que permite realizar la petición HTTP desde Javascript
 para obtener/añadir/modificar/borrar información de manera asíncrona. 
...
const ajax = new XMLHttpRequest() //Variable ajax que instancia del objeto XMLHttpRequest este es una api
